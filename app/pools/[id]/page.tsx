...
export default function PoolDetailsPage() {
  ...
  return (
    <div className="flex flex-col gap-8 pb-20 w-full max-w-5xl mx-auto pt-6">
      <div>
        <Link href="/pools" className="text-muted-foreground hover:text-foreground flex items-center gap-2 text-sm w-fit transition-colors">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start justify-between">
          ...
          >
             ...
             <ul className="space-y-4 text-sm">
                ...
                <li className="flex justify-between items-center border-b border-border/20 pb-2">
                  ...
                  <span className="font-mono font-medium text-green-400">~7.2%</span>
                </li>
                <li className="flex justify-between items-center border-b border-border/20 pb-2">
        ...
        >
          {mounted && connected ? (
            ...
            <div className="w-full p-10 text-center border border-border/40 rounded-3xl 
            ...
            >
              ...
              <p className="text-muted-foreground text-sm">Connect your Solana wallet to interact with this pool.</p>
            </div>
          )}
        </motion.div>
      </div>
