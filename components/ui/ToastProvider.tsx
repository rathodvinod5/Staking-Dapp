...
const positionClasses: Record<ToastPosition, string> = {
  ...
  "bottom-center": "bottom-0 left-1/2 -translate-x-1/2 flex-col-reverse justify-end",
    ...
    <ToastContext.Provider value={{ toast }}>
      <ToastPrimitives.Provider swipeDirection="right">
        ...
        {toasts.map((t) => (
          ...
          >
            {t.title && <ToastPrimitives.Title className="font-medium text-sm">{t.title}</ToastPrimitives.Title>}
            {t.description && <ToastPrimitives.Description className="text-zinc-400 text-sm">{t.description}</ToastPrimitives.Description>}
        ...
        <ToastPrimitives.Viewport className={`fixed z-[100] flex max-h-screen w-full flex-col p-4 md:max-w-[420px] ${positionClasses[position]}`} />
